...
* **Analysis summary**: Our reverse engineering confirmed this sentence from the story. It showed that King raises approximately $2.2 million, that 10.9% (roughly 11) of it was from MD, and that approximately $240,000 was the amount from Maryland ($238,527 to be exact). This limited reliance on in-state contributions is notable because it highlights King’s strategy to garner broader national support rather than relying solely on local backers. The data implies that King’s appeal extends beyond Maryland. This is information that could be useful to Maryland voters to learn about his character and also brings up  questions into who is backing King from across the country.
...
* **Analysis summary**: The sum of the 2021 year filing for Wes Moore was $1.74 million, which is consistent with the sentence above. We also ran the sums for the other leading candidates (King, Perez, and Franchot), and Moore did indeed have the highest sum from MD. For context, King was roughly $240k, Perez $764k, and Franchot $1.3 million. This discrepancy shows Moore had strong local support, which could indicate that Maryland voters saw him as more attuned to state issues or representative of their interests.
...
* **Analysis summary**: The reverse engineering produced the same findings as the report. Our code found that 78.07% of Peter Franchot's contributions came from Maryland contributors. This  percentage of local funding for Franchot is far larger from his competitors—Moore, King, and Perez—who each brought in a higher proportion of out-of-state contributions.
...
* **Analysis summary**: The assertion that King received contributions from every county in the state is false, according to our data. Based on our analysis, King did not receive any contributions from Somerset County. This is interesting since King's campaign is the one who made this claim and could be of interest of Maryland voters. 
