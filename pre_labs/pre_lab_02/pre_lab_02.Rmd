...
**Answer** The code added a line that shows the percentage of votes were made on election day.
...
**Answer** It is focusing on the information that is important so it now shows the six things we want to know and it arranged by percentage.
...
**Answer** It is interesting to see how many people had 0% votes on election day. It's the same data from before just sorted differently.
...
**Answer** str_to_lower is the opposite, it makes everything uppercase. Another one, str_to_sentence makes it in sentence form and capitalizes the first letter.
...
**Answer** It made a new column that follows the rules we wrote in the code. In other words, it tells us how much every donation is.
...
**Answer**  The largest category is "less than $100"
...
**Answer** The new variable is important to organize the data and make it easier to read.
...
**Answer:** It made a structure for the dates. It changed the layout of the dates to be year/month/day.
...
**Answer** It is giving the first date of the month and showed the results for that month. It makes it easier to read and quickly filter by month.
