...
**Task** Load the five CSV files. Do they have the same column structure? **Answer** It looks like they do have the same column structure.
...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? **Answer** It says "joining with 'by = join_by(county)'".
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer** The county with the highest is Prince George's with 60% and is also the highest democrats with 78%.
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer** The percentages are much lower. Howard has the highest percentage with 19% which differs with the PG 78% democrat.
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N? column? **Answer** It is dbl or double.
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N now? **Answer** Now it is a character.
