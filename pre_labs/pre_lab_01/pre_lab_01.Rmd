...
**Answer** The answer here only found certain data. Instead of providing thing slike the name, org name, etc., it found just the date and count_contribs.
...
**Answer** This time, it sorted the data in the count_contribs column from most to least.
...
**Answer** This time it added memo_text and amount in place of the date. It is still sorted by count_contribs.
...
**Answer** This time it added the total_amount and it is sorted most to least.
...
**Answer** Now it shows the mean and median amount and you can see more data.
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** This added two more mathematical lines, min and max. The data is sorted by city.
