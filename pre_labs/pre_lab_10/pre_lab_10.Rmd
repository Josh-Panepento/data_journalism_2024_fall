...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** I see the number of rows and columns and it looks similar to glimpsing at data usually. There are 10 columns and the one that stands out is the last one, "shape".
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** There is information about the precincts like names, council, school and there is also shape length and area.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is a map of PG County that is split up by precinct. There are also grid points where you can see the latitude and longitude.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It says I installed tigris.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It says its retrieving data for the year 2022 and then looks like the usual glimpse. There are 3,235 rows and 18 columns.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It should be making it so there are only Maryland counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is a map of Maryland split up by counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is another map of PG County divided by precincts. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** It shows the row and column amount and specifies the characters and doubles.
...
**Task** Run the following code. Describe the output in the space below. **Answer** There is no visual output but it should be combining the precinct shapes and turnout data.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The PG County precincts are now highlighted to show total eligible voters in each precinct.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It shows the table with 24 rows of counties and their election eligible voter numbers.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's another table of all the counties and this time it shows population estimates.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It says it's getting the data and then it shows some information about the data.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's another table with Maryland counties but with cleaner names.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It shows that it cleaned up the names.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's another glimpse of a table but now the numbers are joined.
...
**Task** Run the following code. Describe the output in the space below. **Answer** There is no visual output but it mutated two of the counties to join them correctly since they had different names in the two data sets.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It's another glimpse that tells us it joined by county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is the Maryland map by county but this time it is shaded in blue based on voters per 10k.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The same map and metrics but the color scheme has changed so now it is multiple colors other than blue.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** Voters per 10k is lower in the Montgomery and PG Counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** It made a mutate for unaffiliated voters per 10k.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Answer** The highest counties are the ones in cnetral Maryland and closer to Baltimore like Howard County.
